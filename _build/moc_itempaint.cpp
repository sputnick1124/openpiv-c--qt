...
static const char qt_meta_stringdata_ItemPaint[] = {
    "ItemPaint\0\0gridDrawn()\0vectorsDrawn()\0"
};
...
const QMetaObjectExtraData ItemPaint::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ItemPaint::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ItemPaint,
      qt_meta_data_ItemPaint, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ItemPaint::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ItemPaint))
